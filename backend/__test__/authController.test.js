...
describe('authController Unit Testing - Auth Controller', () => {
    ...
    // Test suite for the signup functionality
    describe('authController - signup', () => {
        ...
        // Test that an error is returned if the user already exists with role "Administrador"
        ...
        // Test that an error is returned if the user already exists with any role
