  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/park"
          element={isAuthenticated ? <ParkingSpace /> : <Login />}
        />
        <Route
          path="/parkhistory"
          element={isAuthenticated ? <ParkingHistory /> : <Login />}
        />
        <Route
          path="/time-parking"
          element={isAuthenticated ? <TimeParkingSearch /> : <Login />}
        />
        <Route
        ...
        <Route
          ...
          element={isAuthenticated ? <UsualCustomers /> : <Login />}
        />
        <Route
          path="/vehicles"
        ...
        <Route
          ...
          element={isAuthenticated ? <VehiclesHistory /> : <Login />}
        />
        <Route
          path="/incomehistory"
          element={
        ...
        <Route
          path="/dailyincome"
          element={isAuthenticated ? <DailyIncome /> : <Login />}
        />
        <Route
          path="/module_contact"
          element={isAuthenticated ? <ContactComponent /> : <Login />}
        />
        <Route
          path="/module_about"
          element={isAuthenticated ? <InformationComponent /> : <Login />}
        />
        <Route
        ...
        <Route
          path="/error-page"
          element={isAuthenticated ? <UserRoleError /> : <Login />}
        />
        <Route
          path="/about"
          element={
